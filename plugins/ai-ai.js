...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  try {
    // 🚨 Deteksi otomatis prompt generate gambar
    ...
    // Jika ada gambar → pakai Gemini untuk edit
    if (imageUrl) {
    ...
    // Default → AI chat dengan Claude Sonnet-4
    let chatId = m.chat
